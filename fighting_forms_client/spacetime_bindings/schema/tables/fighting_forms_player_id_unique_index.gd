...
class_name FightingFormsPlayerIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[PackedByteArray, FightingFormsPlayer] = {}
...
func find(col_val: PackedByteArray) -> FightingFormsPlayer:
