...
class_name FightingFormsCharacterIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[int, FightingFormsCharacter] = {}
...
func find(col_val: int) -> FightingFormsCharacter:
